...
<body>
    ...
    <div class="container">
        <div class="cardtitle">
            ...
            <button type="button" class="btn btn-outline-warning btnd" id="openCreatPost"><b id="alsocreat">Criar Post</b></button>
            <button type="button" class="btn btn-outline-warning btnr" id="openCreatPostM"><b>+</b></button>
        </div>
        ...
        <div class="tabela">
            ...
            <table class="tbb">
                <tbody>
                    <tr>
                        <th class="t1th">1</th>
                        <td class="t2th">Biografia: Ayrton Senna</td>
                        <td class="t3th">
                            <button type="button" class="btn btn-outline-light btnd" id="openVerPost">Visualizar</button>
                            <button type="button" class="btn btn-outline-info btnd" id="openEditPost">Editar</button>
                            <button type="button"class="btn btn-outline-danger btnd" id="openRmvPost">Excluir</button>
                            <button type="button" class="btn btn-outline-light btnr" id="openVerPostM">👁</button>
                            <button type="button" class="btn btn-outline-info btnr" id="openEditPostM">✎</button>
                            <button type="button"class="btn btn-outline-danger btnr" id="openRmvPostM"><ion-icon name="trash-outline"></ion-icon></button>
                        </td>
                    </tr>
                    <tr>
                        <th class="t1th">2</th>
                        <td class="t2th">McLaren quebra o record mundial de tempo no pit stop</td>
                        <td class="t3th">
                            <button type="button" class="btn btn-outline-light btnd">Visualizar</button>
                            <button type="button" class="btn btn-outline-info btnd">Editar</button>
                            <button type="button"class="btn btn-outline-danger btnd">Excluir</button>
                            <button type="button" class="btn btn-outline-light btnr">👁</button>
                            <button type="button" class="btn btn-outline-info btnr">✎</button>
                            <button type="button"class="btn btn-outline-danger btnr"><ion-icon name="trash-outline"></ion-icon></button>
                        </td>
                    </tr>
                    <tr>
                        <th class="t1th">3</th>
                        <td class="t2th">Autodromo de interlagos</td>
                        <td class="t3th">
                            <button type="button" class="btn btn-outline-light btnd">Visualizar</button>
                            <button type="button" class="btn btn-outline-info btnd">Editar</button>
                            <button type="button"class="btn btn-outline-danger btnd">Excluir</button>
    ...
    <div class = "modal" id="modal_ver">
        ...
        <form action = "processar_cadastro.php" method = "post" enctype = "multipart/form-data">
            ...
            <div class = "botoes" >
                ...
                <button class = "btn btn-primary closever Cancelar" > Cancelar </button>
            </div>
